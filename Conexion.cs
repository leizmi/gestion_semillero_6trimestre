...
namespace gestión_semillero_6trimestre
{
    ...
    internal class Conexion
    {
        ...
        public SqlConnection Conectar() // creamos el metodo Conectar para establecer la conexion a la base de datos
        {
            ...
            {
                con = new SqlConnection("Data Source=CHATGPTTUPAPÁ\\SQLEXPRESS;Initial Catalog =gestión-semillero;Integrated Security=True"); // establecemos la conexion a la base de datos utilizando la cadena de conexion
